...
[![Version](https://img.shields.io/badge/version-1.17.41-F472B6?style=for-the-badge&labelColor=000000)](https://github.com/rushikeshsakharleofficial/we-are-linux-administrators/blob/main/.claude-plugin/plugin.json)
[![Skills](https://img.shields.io/badge/skills-113-A78BFA?style=for-the-badge&labelColor=000000)](https://github.com/rushikeshsakharleofficial/we-are-linux-administrators/tree/main/skills)
...
`package.json` is aligned to version **1.17.41** and **113 expert skills**.
...
`/linux-admin:ubuntu-desktop-expert` handles Ubuntu Desktop and flavor environments across GNOME, KDE Plasma/Kubuntu, Xfce/Xubuntu, MATE, Cinnamon, LXQt/Lubuntu, Budgie, UKUI/Kylin, Unity, Ubuntu Studio desktop workflows, Wayland/Xorg, display managers, kernels, graphics drivers, PipeWire/audio, UI customization, extensions/plugins, desktop security, release upgrades, and rollback-aware troubleshooting.

```bash
/linux-admin:ubuntu-desktop-expert gnome extensions broke after upgrade
/linux-admin:ubuntu-desktop-expert kubuntu black screen after nvidia update
/linux-admin:ubuntu-desktop-expert choose best ubuntu flavor for low ram laptop
```
