...
[![Version](https://img.shields.io/badge/version-1.17.51-F472B6?style=for-the-badge&labelColor=000000)](https://github.com/rushikeshsakharleofficial/we-are-linux-administrators/blob/main/.claude-plugin/plugin.json)
...
Current plugin metadata version: **1.17.51**  
...
`package.json` is aligned to version **1.17.51** and **113 expert skills**.
