...
Before changing skills, docs, package metadata, plugin metadata, agent compatibility, or site release text, read the relevant files first:
...
- Do not hallucinate versions, skill counts, install status, package names, file paths, tool compatibility, publication status, or source claims.
...
- For AI-tool compatibility claims, verify current official documentation before changing support guidance.
