...
REQUIRED_SKILLS = ['acl-permissions-expert', 'ansible-expert', 'apache-expert', 'apparmor-expert', 'auditd-expert', 'auth', 'automation', 'backup-restore-expert', 'bash-script-expert', 'bashrc-expert', 'boot', 'capacity-planning-expert', 'cf-expert', 'chrony-expert', 'command-expert', 'containers', 'cpu-expert', 'cron-scheduler-expert', 'date-timectl-expert', 'diagnose', 'disk-mounting-expert', 'dnsmasq-expert', 'docker-expert', 'fail2ban-expert', 'file-permissions-expert', 'filesystem-expert', 'firewall-expert', 'grep-expert', 'haproxy-expert', 'incident-response-expert', 'io-wait-expert', 'iproute-expert', 'iscsi-expert', 'kernel', 'kernel-expert', 'kubernetes-node-expert', 'limits-expert', 'load-average-expert', 'logrotate-expert', 'logs', 'lvm-expert', 'memory-expert', 'migration-expert', 'multipath-expert', 'mysql-expert', 'named-expert', 'natting-expert', 'network', 'networking-expert', 'nfs-expert', 'nginx-expert', 'ntp-expert', 'os-security-expert', 'package-manager-expert', 'packages', 'pam-expert', 'patching-expert', 'performance', 'permissions', 'php-fpm-expert', 'podman-expert', 'postgresql-expert', 'process-expert', 'proxy-expert', 'quota-expert', 'raid-expert', 'redis-expert', 'routing-expert', 'rsyslog-expert', 'runbook-expert', 'samba-expert', 'selinux-expert', 'service', 'shell-script-expert', 'smart-disk-expert', 'ssh-hardening-expert', 'sssd-ldap-expert', 'storage', 'sudoers-expert', 'swap-expert', 'sysctl-expert', 'systemd-expert', 'tcp-expert', 'tcpdump-expert', 'udp-expert', 'user-permissions-expert', 'vlan-bonding-expert', 'vulnerability-scan-expert', 'zshrc-expert']
