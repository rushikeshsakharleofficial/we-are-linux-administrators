...
- `agent-model-dispatcher-expert` — routes tasks across Claude Code, Codex, OpenCode, GitHub Copilot, Cursor, Windsurf, Cline, Amazon Q Developer, Zed Agent, JetBrains Junie, Aider, Sourcegraph Cody, goose, Bedrock-backed clients, local tools, and other verified agent surfaces.
...
- `docs/AI_TOOL_SUPPORT.md` — documents the maintained cross-tool compatibility matrix and thin-adapter model.
