#!/usr/bin/env python3
"""Read-only TCP audit helper kept for legacy command compatibility."""
...
def main():
    print(json.dumps({"read_only":True,"legacy_command":True,"parent_skill":"network","chunk":"chunks/tcp.md","host":platform.node(),"kernel":platform.release(),"commands":[run(c) for c in COMMANDS]}, indent=2, sort_keys=True))
