...
# Harden common /tmp sticky-directory race classes.
...
Do not apply this blindly on routers, VPN gateways, lab machines needing permissive debugging, or developer workstations.

## Profile 2: Web/API/load balancer candidate
...
## Profile 3: High-throughput network candidate
...
## Profile 4: Database/cache candidate
...
## Profile 5: Router/VPN/NAT host candidate
...
## Profile 6: Container/Kubernetes host candidate
...
## Profile 8: Monitoring/Zabbix/observability server candidate
