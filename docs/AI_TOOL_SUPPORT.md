...
`linux-admin` keeps one canonical 75-skill tree under `skills/` and uses thin adapters or native Agent Skills discovery instead of vendor-specific copies.
...
6. Never duplicate all 75 skills into vendor-specific folders merely to advertise support.
